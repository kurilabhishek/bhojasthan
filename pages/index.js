  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Delicious, hygienic, and affordable home-style tiffin meals for students and working professionals in Lucknow."
        />
        <meta
          name="keywords"
          content="tiffin service, home-style food, Lucknow meals, student lunch, Bhojasthan"
        />
        <meta property="og:title" content="Bhojasthan | Home-style Tiffin Service" />
        <meta
          property="og:description"
          content="Tasty and hygienic home-cooked food, delivered daily."
        />
